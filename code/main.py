...
# for train_data_name in ['CollectedData_all']:
# for train_data_name in ['CollectedData_all_supervised', 'CollectedData_all_exclude_tongue_pca']:
# for train_data_name in ['CollectedData_all_supervised']:
for train_data_name in ['CollectedData_all']:


# for train_data_name in ['test']:
...
# for train_data_name in ['HH08_exclude_frames_include_video']:
    ...
    # if train_data_type != "mouse_exclude_frames_include_video":
